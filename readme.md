| Board | ESP32 DevKitC | ESP32-S3 DevKitC | Raspberry Pi Pico | Black Pill |
| --- | :-: | :-: | :-: | :-: |
...
Board Pins | 38 pins<br>(similar DOIT version has 36 pins)| 44 pins | 40 pins | 40 pins
...
PWM | 16<br>(8 timers each with 2 output pins) | 16<br>(8 timers each with 2 output pins) | 16<br>(8 timers each with 2 output pins) | 25<br>(7 timers)
...
On Board Peripherals | WIFI + BT + Button | WIFI + BT + Button + RGB LED | LED (+ optional WIFI + BT) | Button + LED (+ optional SPI flash)
MCU | ESP32 | ESP32S3 | RP2040 | STM32F411
MCU GPIO | 34 | 45 | 30 | 32
Processor | 2 * 240MHz LX6 | 2 * 240MHz LX7 | 2 * 133MHz M0+ | 1 * 100MHz M4
RAM | 520K | 512K | 264K | 128K
Flash | 2-16M QuadSPI | 2-16M OctalSPI | 2M QuadSPI | 512K internal
PSRAM | 0-8M | 0-8M | 0 | 0
