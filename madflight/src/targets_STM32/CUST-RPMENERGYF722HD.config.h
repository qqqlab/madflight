...
//RC Receiver: (SERIAL3)
const int HW_PIN_RCIN_RX  = NONE;
const int HW_PIN_RCIN_TX  = NONE;
HardwareSerial *rcin_Serial = new HardwareSerial(HW_PIN_RCIN_RX, HW_PIN_RCIN_TX);

//IMU:
const int HW_PIN_IMU_INT  = B00;
...
const int8_t HW_PIN_OUT[HW_OUT_COUNT] = {PC6,PC7,PC8,PC9};
