...
//GPS: (SERIAL1)
const int HW_PIN_GPS_RX   = NONE;
const int HW_PIN_GPS_TX   = NONE;
...
const int8_t HW_PIN_OUT[HW_OUT_COUNT] = {PB0,PB1,PA6,PA7,PA0,PA1,PA2,PA3};
