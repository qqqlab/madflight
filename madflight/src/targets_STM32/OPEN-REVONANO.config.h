...
const int HW_PIN_BAT_ADC  = A06;
const int HW_PIN_BAT_CURR = A07;
...
//IMU:
const int HW_PIN_IMU_INT  = A15;

//I2C: (I2C3)
const int HW_PIN_I2C_SDA  = A08;
const int HW_PIN_I2C_SCL  = B04;
...
const int8_t HW_PIN_OUT[HW_OUT_COUNT] = {PA10,PB3,PB8,PB9,PA0,PA1};
