/*==============================================================================
Generated on: 2023-12-28 01:59:36.724928
...
#include "betaflight-targets/SDRC-SDMODELH7.config.h"
==============================================================================*/
...
const int HW_PIN_SPI_CS   = PE4;
const int HW_PIN_SPI_SCLK = PE2;
const int HW_PIN_SPI_MOSI = PE6;

//Outputs:
#define HW_OUT_COUNT 8
const int16_t HW_PIN_OUT[HW_OUT_COUNT] = {PB0,PB1,PB3,PB10,PA0,PA2,PC8,PC9};
