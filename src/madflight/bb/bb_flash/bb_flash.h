/*========================================================================================================================
Black Box logging to external flash, internal flash, RAM, or PSRAM
...
public:
  ...
  void bench() {
    Serial.println("Not implemented for BB_FLASH");
  }
