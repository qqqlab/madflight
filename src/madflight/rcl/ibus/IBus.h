 ...
 * Modified 7 June 2025 Atin M <atinm.dev@gmail.com> for madflight
 */
#ifndef IBus_h
#define IBus_h
...
public:
  ...
  bool update(void); // used internally for interrupt handline, but needs to be defined as public
...
private:
  ...
  IBus* IBusnext = nullptr;        // pointer to the next class instance to be used to call the loop() method from timer interrupt
};
