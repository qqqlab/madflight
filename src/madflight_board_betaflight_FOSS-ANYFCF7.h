/*==============================================================================
Generated on: 2024-03-11 20:33:43.589807
...
#include "boards/../madflight_board_betaflight_FOSS-ANYFCF7.h"
==============================================================================*/

#define HW_BOARD_NAME "BETAFLIGHT-FOSS-ANYFCF7"
...
const int HW_PIN_OUT[]    = {PB8,PA2,PA1,PA3,PB5,PA0,PB9,PE6};
...
#define HW_PIN_SERIAL { {1,PA9,PA10,-1}, {2,PD5,PD6,-1}, {3,PD8,PD9,-1}, {4,PC10,PC11,-1}, {5,PC12,PD2,-1}, {6,PC6,PC7,-1}, {7,PE8,PE7,-1}, {8,PE1,PE0,-1} } // {INDEX,TX,RX,INVERTER}

//SPI
#define HW_SPI_COUNT 3
#define HW_PIN_SPI { {1,PA5,PA6,PA7}, {3,PC10,PC11,PC12}, {4,PE12,PE13,PE14} } // {INDEX,SCK,MISO,MOSI}

//I2C
#define HW_I2C_COUNT 2
#define HW_PIN_I2C { {2,PB10,PB11}, {4,PD12,PD13} } // {INDEX,SCL,SDA}

//Motors:
#define HW_MOTOR_COUNT 8
#define HW_MOTOR_OUT {PB8,PA2,PA1,PA3,PB5,PA0,PB9,PE6}
...
#define HW_PIN_SDCARD_CS PE11
#define HW_PIN_SDCARD_DETECT PD3
