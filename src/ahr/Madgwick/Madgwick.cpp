...
void Madgwick::update9DOF(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, float dt) {
...
void Madgwick::update6DOF(float gx, float gy, float gz, float ax, float ay, float az, float dt) {
