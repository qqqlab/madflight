...
#include "boards/../madflight_board_betaflight_FFPV-FF_PIKOF4OSD.h"
==============================================================================*/
...
const int HW_PIN_OUT[]    = {PA3,PB0,PA2,PB1,PB14,PB15};
...
const int HW_PIN_GPS_INVERTER = PC3;
...
#define HW_PIN_SERIAL { {1,PA9,PA10,-1}, {3,PB10,PB11,PC3}, {4,PA0,PA1,-1}, {6,PC6,PC7,-1} } // {INDEX,TX,RX,INVERTER}
...
#define HW_MOTOR_OUT {PA3,PB0,PA2,PB1,PB14,PB15}
