/*==============================================================================
Generated on: 2024-03-11 20:33:44.790897
Generated by: betaflight_target_converter.py
Source: https://github.com/betaflight/unified-targets
Board name: SPEDIXF4
Manufacturer ID: SPDX

//copy this line to madflight.ino to use this flight controller (or copy/paste the whole file)
#include "boards/../madflight_board_betaflight_SPDX-SPEDIXF4.h"
==============================================================================*/

#define HW_BOARD_NAME "BETAFLIGHT-SPDX-SPEDIXF4"
...
const int HW_PIN_OUT[]    = {PB6,PB7,PB8,PB9,PB0,PB1};

//RC Receiver: (SERIAL1)
const int HW_PIN_RCIN_RX  = PA10;
const int HW_PIN_RCIN_TX  = PA9;
const int HW_PIN_RCIN_INVERTER = PC14;
...
#define HW_PIN_SERIAL { {1,PA9,PA10,PC14}, {2,PA2,PA3,-1}, {3,PC10,PC11,-1}, {4,PA0,PA1,-1}, {5,PC12,PD2,PC15}, {6,PC6,PC7,-1} } // {INDEX,TX,RX,INVERTER}
...
resource INVERTER 1 C14
resource INVERTER 5 C15
